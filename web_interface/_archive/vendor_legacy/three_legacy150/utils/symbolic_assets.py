"""Symbolic asset manifest for `web_interface/vendor/three_legacy150/utils`."""
...
def build_asset_manifest() -> Dict[str, float]:
    ctx = {
        ...
        "metadata": {"asset_path": "web_interface/vendor/three_legacy150/utils"},
    }
    signals = SymbolicEquation41().evaluate(ctx).to_dict()
    return {
        "asset_root": "web_interface/vendor/three_legacy150/utils",
        "signals": signals,
    }
