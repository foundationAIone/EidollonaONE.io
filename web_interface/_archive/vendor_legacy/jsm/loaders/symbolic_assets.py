"""Symbolic asset manifest for `web_interface/vendor/jsm/loaders`."""
...
def build_asset_manifest() -> Dict[str, float]:
    ctx = {
        ...
        "metadata": {"asset_path": "web_interface/vendor/jsm/loaders"},
    }
    signals = SymbolicEquation41().evaluate(ctx).to_dict()
    return {
        "asset_root": "web_interface/vendor/jsm/loaders",
        "signals": signals,
    }
