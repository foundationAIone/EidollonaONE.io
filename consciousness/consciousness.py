"""Symbolic utilities for the `consciousness` data bucket."""
...
__all__ = ["ConsciousnessSnapshot", "load_snapshot", "refresh_snapshot"]
...
_DEFAULT_CONTEXT = {
    ...
    "metadata": {"bucket": "consciousness", "module": "consciousness"},
}
...
def load_snapshot(root: Path | None = None) -> ConsciousnessSnapshot:
    ...
    if path.exists():
        ...
        return ConsciousnessSnapshot(bucket="consciousness", context=ctx, signals=sig)
    signals = _EQ.evaluate(_DEFAULT_CONTEXT).to_dict()
    snapshot = ConsciousnessSnapshot(bucket="consciousness", context=_DEFAULT_CONTEXT, signals=signals)
    path.write_text(json.dumps(snapshot.to_dict(), indent=2), encoding="utf-8")
    return snapshot


def refresh_snapshot(context_override: Dict[str, Any] | None = None) -> ConsciousnessSnapshot:
    ...
    snapshot = ConsciousnessSnapshot(bucket="consciousness", context=ctx, signals=signals)
