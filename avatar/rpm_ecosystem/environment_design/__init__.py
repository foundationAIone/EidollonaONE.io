"""Symbolic scaffolding for the `avatar/rpm_ecosystem/environment_design` package.
...
def default_symbolic_profile() -> Dict[str, Any]:
    ...
    context = {
        ...
        "metadata": {"generated_at": datetime.now(timezone.utc).isoformat(), "package": "avatar/rpm_ecosystem/environment_design"},
    }
