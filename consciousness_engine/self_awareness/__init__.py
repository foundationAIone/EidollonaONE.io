"""Symbolic scaffolding for the `consciousness_engine/self_awareness` package.
...
def default_symbolic_profile() -> Dict[str, Any]:
    ...
    context = {
        ...
        "metadata": {"generated_at": datetime.now(timezone.utc).isoformat(), "package": "consciousness_engine/self_awareness"},
    }
