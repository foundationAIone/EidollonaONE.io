"""Symbolic scaffolding for the `internet_access/system_backups` package.
...
def default_symbolic_profile() -> Dict[str, Any]:
    ...
    context = {
        ...
        "metadata": {"generated_at": datetime.now(timezone.utc).isoformat(), "package": "internet_access/system_backups"},
    }
