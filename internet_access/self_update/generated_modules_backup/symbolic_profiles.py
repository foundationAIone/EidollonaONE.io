"""Symbolic profile helpers for `internet_access/self_update/generated_modules_backup`."""
...
_BASE_CONTEXT = {
    ...
    "metadata": {"package": "internet_access/self_update/generated_modules_backup"},
}
