"""Symbolic scaffolding for the `internet_access/self_update/generated_modules_backup` package.
...
def default_symbolic_profile() -> Dict[str, Any]:
    ...
    context = {
        ...
        "metadata": {"generated_at": datetime.now(timezone.utc).isoformat(), "package": "internet_access/self_update/generated_modules_backup"},
    }
