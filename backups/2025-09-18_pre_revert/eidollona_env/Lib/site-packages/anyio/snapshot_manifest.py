"""Snapshot manifest utilities for `backups/2025-09-18_pre_revert/eidollona_env/Lib/site-packages/anyio`."""
...
def snapshot_summary() -> Dict[str, float]:
    ctx = {
        ...
        "metadata": {"snapshot": "backups/2025-09-18_pre_revert/eidollona_env/Lib/site-packages/anyio"},
    }
