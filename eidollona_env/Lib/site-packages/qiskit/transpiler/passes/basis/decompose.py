...
class Decompose(TransformationPass):
    ...
    def run(self, dag: DAGCircuit) -> DAGCircuit:
        ...
        hls = (
            HighLevelSynthesis(qubits_initially_zero=False)
    ...
    def _should_decompose(self, node: DAGOpNode) -> bool:
        ...
        if (
            ...
            isinstance(node.op, op) for op in gate_type_list
        ):  # check if Gate type given
            return True
        else:
            return False
