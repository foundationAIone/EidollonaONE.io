        ...
        for possibility in possibilities:
            if (
                ...
                for single_run in runs:
                    if (
                        len(single_run) != 0
                        and single_run[0].qargs == possibility.qargs
    ...
    def _step(self, dag):
        ...
        for run in runs:
            ...
            new_preceding_run = self._resynthesize(
                preceding_run + commuted_preceding, qubit
            )
            new_succeeding_run = self._resynthesize(
                commuted_succeeding + succeeding_run, qubit
            )
            ...
            if self._optimize1q._substitution_checks(
                ...
                new_preceding_run.op_nodes()
                + new_run.op_nodes()
                + new_succeeding_run.op_nodes(),
