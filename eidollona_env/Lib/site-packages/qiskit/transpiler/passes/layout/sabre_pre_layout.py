    ...
    def _minimize_extra_edges(self, dag, starting_layout):
        ...
        while extra_edges_unprocessed_set:
            ...
            layout = self._find_layout(
                dag,
                real_edges + extra_edges_necessary + list(extra_edges_unprocessed_set),
            )
            ...
            if layout is None:
                ...
                extra_edges_unprocessed_set = self._get_extra_edges_used(
                    dag, layout
                ).difference(set(extra_edges_necessary))
                best_layout = layout
