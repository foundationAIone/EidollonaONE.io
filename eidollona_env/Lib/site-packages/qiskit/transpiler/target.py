...
class InstructionProperties(BaseInstructionProperties):
    ...
    def __new__(  # pylint: disable=keyword-arg-before-vararg
        ...
        **kwargs,  # pylint: disable=unused-argument
        ...
        return super(
            InstructionProperties, cls
        ).__new__(  # pylint: disable=too-many-function-args
            cls, duration, error
        )
...
class Target(BaseTarget):
    ...
    def add_instruction(self, instruction, properties=None, name=None):
        ...
        if instruction_name in self._gate_map:
            raise AttributeError(
                f"Instruction {instruction_name} is already in the target"
            )
    ...
    def instruction_properties(self, index):
        ...
        instruction_properties = [
            ...
            for inst_props in qargs.values()
        ]
    ...
    def _filter_coupling_graph(self):
        has_operations = set(
            itertools.chain.from_iterable(x for x in self.qargs if x is not None)
        )
        ...
        if coupling_map is None:
            ...
            for gate in one_qubit_gates:
                ...
                target.add_instruction(
                    name_mapping[gate], properties=gate_properties, name=gate
                )
