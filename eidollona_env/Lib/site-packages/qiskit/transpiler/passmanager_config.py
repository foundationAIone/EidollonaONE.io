...
class PassManagerConfig:
    ...
    def from_backend(cls, backend, _skip_target=False, **pass_manager_options):
        ...
        if res.scheduling_method is None and hasattr(
            backend, "get_scheduling_stage_plugin"
        ):
            res.scheduling_method = backend.get_scheduling_stage_plugin()
        if res.translation_method is None and hasattr(
            backend, "get_translation_stage_plugin"
        ):
