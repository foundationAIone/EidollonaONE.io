        ...
        if optimization_level == 0:
            ...
            if pass_manager_config.approximation_degree is not None:
                init.append(
                    Split2QUnitaries(
                        pass_manager_config.approximation_degree,
                        split_swap=split_2q_unitaries_swap,
                    )
                )
            else:
...
class DefaultTranslationPassManager(PassManagerStagePlugin):
    ...
    def pass_manager(self, pass_manager_config, optimization_level=None) -> PassManager:
        ...
        return BasisTranslatorPassManager().pass_manager(
...
class DefaultRoutingPassManager(PassManagerStagePlugin):
    ...
    def pass_manager(self, pass_manager_config, optimization_level=None) -> PassManager:
        ...
        return SabreSwapPassManager().pass_manager(
            pass_manager_config, optimization_level
        )
    ...
    def pass_manager(self, pass_manager_config, optimization_level=None) -> PassManager:
        ...
        if optimization_level == 0:
            routing_pass = LookaheadSwap(
                coupling_map_routing, search_depth=2, search_width=2
            )
            return common.generate_routing_passmanager(
                routing_pass,
                target,
        ...
        if optimization_level == 1:
            routing_pass = LookaheadSwap(
                coupling_map_routing, search_depth=4, search_width=4
            )
            return common.generate_routing_passmanager(
                routing_pass,
                target,
        ...
        if optimization_level == 2:
            routing_pass = LookaheadSwap(
                coupling_map_routing, search_depth=5, search_width=6
            )
            return common.generate_routing_passmanager(
                routing_pass,
                target,
...
class DefaultSchedulingPassManager(PassManagerStagePlugin):
    ...
    def pass_manager(self, pass_manager_config, optimization_level=None) -> PassManager:
        ...
        timing_constraints = (
            pass_manager_config.timing_constraints or TimingConstraints()
        )
        target = pass_manager_config.target
...
class DefaultLayoutPassManager(PassManagerStagePlugin):
    ...
    def pass_manager(self, pass_manager_config, optimization_level=None) -> PassManager:
        ...
        if coupling_map is None:
            ...
            layout.append(
                ConditionalController(choose_layout_1, condition=_layout_not_perfect)
            )
