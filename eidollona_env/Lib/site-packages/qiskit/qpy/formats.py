...
ANNOTATION_STATE_HEADER = namedtuple(
    "ANNOTATION_STATE_HEADER", ["namespace_size", "state_size"]
)
ANNOTATION_STATE_HEADER_PACK = "!IQ"
ANNOTATION_STATE_HEADER_SIZE = struct.calcsize(ANNOTATION_STATE_HEADER_PACK)

INSTRUCTION_ANNOTATIONS_HEADER = namedtuple(
    "INSTRUCTION_ANNOTATIONS_HEADER", ["num_annotations"]
)
INSTRUCTION_ANNOTATIONS_HEADER_PACK = "!I"
INSTRUCTION_ANNOTATIONS_HEADER_SIZE = struct.calcsize(
    INSTRUCTION_ANNOTATIONS_HEADER_PACK
)

INSTRUCTION_ANNOTATION = namedtuple(
    "INSTRUCTION_ANNOTATION", ["namespace_index", "payload_size"]
)
...
# Modifier
MODIFIER_DEF = namedtuple(
    "MODIFIER_DEF", ["type", "num_ctrl_qubits", "ctrl_state", "power"]
)
...
# CALIBRATION_DEF
CALIBRATION_DEF = namedtuple(
    "CALIBRATION_DEF", ["name_size", "num_qubits", "num_params", "type"]
)
...
EXPR_VAR_DECLARATION = namedtuple(
    "EXPR_VAR_DECLARATION", ["uuid_bytes", "usage", "name_size"]
)
