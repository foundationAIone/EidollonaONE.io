...
def add_control(
    ...
    if isinstance(operation, UnitaryGate):
        ...
        operation._define()
    cgate = control(
        operation, num_ctrl_qubits=num_ctrl_qubits, label=label, ctrl_state=ctrl_state
    )
...
def control(
    ...
    if operation.name in EFFICIENTLY_CONTROLLED_GATES:
        ...
        unrolled_gate = _unroll_gate(
            operation, basis_gates=EFFICIENTLY_CONTROLLED_GATES
        )
