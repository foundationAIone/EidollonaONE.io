...
class Isometry(Instruction):
    ...
    def _gates_to_uncompute(self):
        ...
        remaining_isometry = self.iso_data.astype(
            complex
    ...
    def _disentangle(self, circuit, q, diag, remaining_isometry, column_index, s):
        ...
        if (
            ...
            v = isometry_rs.apply_multi_controlled_gate(
                v, control_labels, target_label, gate
            )
        ...
        if not isometry_rs.ucg_is_identity_up_to_global_phase(
            single_qubit_gates, self._epsilon
        ):
