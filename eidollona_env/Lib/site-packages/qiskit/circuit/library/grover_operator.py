...
def grover_operator(
    ...
    if reflection_qubits is None:
        reflection_qubits = [
            ...
            if not isinstance(qubit, AncillaQubit)
        ]
...
class GroverOperator(QuantumCircuit):
    ...
    def __init__(
        ...
        zero_reflection: Optional[
            Union[QuantumCircuit, DensityMatrix, Operator]
        ] = None,
    ...
    def zero_reflection(self) -> QuantumCircuit:
        ...
        num_state_qubits = self.oracle.num_qubits - self.oracle.num_ancillas
        return _zero_reflection(
            num_state_qubits, self.reflection_qubits, self._mcx_mode
        )
    ...
    def _build(self):
        ...
        circuit = QuantumCircuit(
            QuantumRegister(num_state_qubits, name="state"), name="Q"
        )
