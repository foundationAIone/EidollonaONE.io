...
class IntegerComparator(BlueprintCircuit):
    ...
    def _check_configuration(self, raise_on_failure: bool = True) -> bool:
        ...
        if self.num_qubits != required_num_qubits:
            ...
            if raise_on_failure:
                raise CircuitError(
                    "Number of qubits does not match required number of qubits."
                )
    ...
    def _build(self) -> None:
        ...
        circuit = synth_integer_comparator_2s(
            self.num_state_qubits, self.value, self.geq
        )
...
class IntegerComparatorGate(Gate):
    ...
    def _define(self):
        self.definition = synth_integer_comparator_greedy(
            self.num_qubits - 1, self.value, self.geq
        )
