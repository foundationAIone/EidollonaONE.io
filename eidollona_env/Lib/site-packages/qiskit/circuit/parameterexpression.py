...
class ParameterExpression:
    ...
    def gradient(self, param) -> Union["ParameterExpression", complex]:
        ...
        if len(parameter_symbols) > 0:
            return ParameterExpression(
                parameter_symbols, expr=expr_grad, _qpy_replay=qpy_replay
            )
    ...
    def __radd__(self, other):
        return self._apply_operation(
            operator.add, other, reflected=True, op_code=_OPCode.ADD
        )
    ...
    def __rsub__(self, other):
        return self._apply_operation(
            operator.sub, other, reflected=True, op_code=_OPCode.RSUB
        )
    ...
    def __rmul__(self, other):
        return self._apply_operation(
            operator.mul, other, reflected=True, op_code=_OPCode.MUL
        )
    ...
    def __rtruediv__(self, other):
        return self._apply_operation(
            operator.truediv, other, reflected=True, op_code=_OPCode.RDIV
        )
