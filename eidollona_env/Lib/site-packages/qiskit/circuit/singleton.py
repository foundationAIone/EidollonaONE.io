...
def _impl_init_subclass(
    ...
    def __init_subclass__(
        ...
        **kwargs,
        ...
        _Singleton.__name__ = _Singleton.__qualname__ = (
            f"_Singleton{instruction_class.__name__}"
        )
...
class SingletonInstruction(
    Instruction, _SingletonBase, overrides=_SingletonInstructionOverrides
):
