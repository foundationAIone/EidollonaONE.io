...
class BasePrimitiveJob(ABC, Generic[ResultT, StatusT]):
    ...
    def result(self) -> ResultT:
        ...
        raise NotImplementedError(
            "Subclass of BasePrimitiveJob must implement `result` method."
        )
    ...
    def status(self) -> StatusT:
        ...
        raise NotImplementedError(
            "Subclass of BasePrimitiveJob must implement `status` method."
        )
    ...
    def done(self) -> bool:
        ...
        raise NotImplementedError(
            "Subclass of BasePrimitiveJob must implement `done` method."
        )
    ...
    def running(self) -> bool:
        ...
        raise NotImplementedError(
            "Subclass of BasePrimitiveJob must implement `running` method."
        )
    ...
    def cancelled(self) -> bool:
        ...
        raise NotImplementedError(
            "Subclass of BasePrimitiveJob must implement `cancelled` method."
        )
    ...
    def cancel(self):
        ...
        raise NotImplementedError(
            "Subclass of BasePrimitiveJob must implement `cancel` method."
        )
