...
class Shaped(Protocol):
    ...
    def shape(self) -> tuple[int, ...]:
        ...
        raise NotImplementedError(
            "A `Shaped` protocol must implement the `shape` property"
        )
    ...
    def ndim(self) -> int:
        ...
        raise NotImplementedError(
            "A `Shaped` protocol must implement the `ndim` property"
        )
    ...
    def size(self) -> int:
        ...
        raise NotImplementedError(
            "A `Shaped` protocol must implement the `size` property"
        )
