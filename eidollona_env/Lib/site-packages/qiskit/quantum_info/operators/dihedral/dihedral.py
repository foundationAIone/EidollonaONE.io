    ...
    **Circuit Conversion**
    ...
    def __init__(
        ...
        # Initialize from ScalarOp as N-qubit identity discarding any global phase
            ...
            if (
                not data.is_unitary()
                or set(data._input_dims) != {2}
                or data.num_qubits is None
            ):
        ...
        for i in range(elem1.num_qubits):
            ...
            for j in range(i):
                ...
                result.poly.set_term(
                    [j + elem0.num_qubits, i + elem0.num_qubits], value
                )
                for k in range(j):
    ...
    def _is_valid(self):
        ...
        if (
            ...
            or len(self.poly.weight_2)
            != int(self.num_qubits * (self.num_qubits - 1) / 2)
