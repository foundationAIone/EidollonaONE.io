        ...
        if num_state_qubits > 1:
            ...
            for i in range(num_state_qubits):
                if i == 0:
                    ...
                    if twos[i] == 1:
                        circuit.append(
                            OrGate(2), [qr_state[i], qr_ancilla[i - 1], qr_ancilla[i]]
                        )
                    else:
                    ...
                    if twos[i] == 1:
                        ...
                        # access the index [0]
                        circuit.append(
                            OrGate(2), [qr_state[i], qr_ancilla[i - 1], q_compare]
                        )
                    else:
...
def _get_twos_complement(num_bits: int, value: int) -> list[int]:
    ...
    twos_complement = [
        1 if twos_complement[i] == "1" else 0
        for i in reversed(range(len(twos_complement)))
    ]
