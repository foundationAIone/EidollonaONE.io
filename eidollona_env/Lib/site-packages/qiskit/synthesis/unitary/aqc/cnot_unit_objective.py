...
class DefaultCNOTUnitObjective(CNOTUnitObjective):
    ...
    def objective(self, param_values: np.ndarray) -> typing.SupportsFloat:
        ...
        for cnot_index in range(num_cnots):
            ...
            cnot_unit_collection[:, d * cnot_index : d * (cnot_index + 1)] = (
                la.multi_dot([full_q2, full_q1, cnot_q1q2])
            )
        ...
        for cnot_index in range(num_cnots - 1, -1, -1):
            ...
            cnot_right_collection[:, d * cnot_index : d * (cnot_index + 1)] = (
                cnot_matrix
            )
        ...
        for cnot_index in range(num_cnots):
            ...
            for i in range(4):
                ...
                if cnot_index == 0:
                    ...
                    der_cnot_matrix = np.dot(
                        der_cnot_unit,
                        self._cnot_left_collection[
                            :, d * (num_cnots - 2) : d * (num_cnots - 1)
                        ],
                    )
                else:
