...
ScheduledGate.bit_position.__doc__ = (
    "Position of bit associated with this drawing source."
)


GateLink = NamedTuple(
    "GateLink",
    [("t0", int), ("opname", str), ("bits", List[Union[circuit.Qubit, circuit.Clbit]])],
)
...
HorizontalAxis = NamedTuple(
    "HorizontalAxis",
    [("window", Tuple[int, int]), ("axis_map", Dict[int, int]), ("label", str)],
)
...
HorizontalAxis.axis_map.__doc__ = (
    "Mapping of apparent coordinate system and actual location."
)
