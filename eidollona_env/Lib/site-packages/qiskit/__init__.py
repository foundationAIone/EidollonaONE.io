...
try:
    ...
    _has_tools = getattr(
        importlib.util.find_spec("qiskit.tools"), "has_location", False
    )
...
sys.modules["qiskit._accelerate.circuit.classical.expr"] = (
    _accelerate.circuit.classical.expr
)
sys.modules["qiskit._accelerate.circuit.classical.types"] = (
    _accelerate.circuit.classical.types
)
...
sys.modules["qiskit._accelerate.synthesis.permutation"] = (
    _accelerate.synthesis.permutation
)
...
sys.modules["qiskit._accelerate.commutation_analysis"] = (
    _accelerate.commutation_analysis
)
sys.modules["qiskit._accelerate.commutation_cancellation"] = (
    _accelerate.commutation_cancellation
)
...
sys.modules["qiskit._accelerate.synthesis.discrete_basis"] = (
    _accelerate.synthesis.discrete_basis
)
...
sys.modules["qiskit._accelerate.inverse_cancellation"] = (
    _accelerate.inverse_cancellation
)
...
sys.modules["qiskit._accelerate.high_level_synthesis"] = (
    _accelerate.high_level_synthesis
)
sys.modules["qiskit._accelerate.remove_identity_equiv"] = (
    _accelerate.remove_identity_equiv
)
