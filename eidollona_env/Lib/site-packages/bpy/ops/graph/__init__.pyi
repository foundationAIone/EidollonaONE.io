...
def extrapolation_type(
    ...
    *,
    type: (
        typing.Literal["CONSTANT", "LINEAR", "MAKE_CYCLIC", "CLEAR_CYCLIC"] | None
    ) = "CONSTANT",
) -> None:
...
def interpolation_type(
    ...
    *,
    type: (
        bpy.stub_internal.rna_enums.BeztripleInterpolationModeItems | None
    ) = "CONSTANT",
) -> None:
...
def keyframe_insert(
    ...
    *,
    type: (
        typing.Literal["ALL", "SEL", "ACTIVE", "CURSOR_ACTIVE", "CURSOR_SEL"] | None
    ) = "ALL",
) -> None:
...
def paste(
    ...
    *,
    ...
    value_offset: (
        bpy.stub_internal.rna_enums.KeyframePasteOffsetValueItems | None
    ) = "NONE",
...
def select_column(
    ...
    *,
    mode: (
        typing.Literal["KEYS", "CFRA", "MARKERS_COLUMN", "MARKERS_BETWEEN"] | None
    ) = "KEYS",
) -> None:
