...
def cylinder_project(
    ...
    *,
    direction: (
        typing.Literal["VIEW_ON_EQUATOR", "VIEW_ON_POLES", "ALIGN_TO_OBJECT"] | None
    ) = "VIEW_ON_EQUATOR",
...
def pack_islands(
    ...
    *,
    udim_source: (
        typing.Literal["CLOSEST_UDIM", "ACTIVE_UDIM", "ORIGINAL_AABB"] | None
    ) = "CLOSEST_UDIM",
    ...
    pin: bool | None = False,
    pin_method: (
        typing.Literal["SCALE", "ROTATION", "ROTATION_SCALE", "LOCKED"] | None
    ) = "LOCKED",
...
def smart_project(
    ...
    *,
    ...
    margin_method: typing.Literal["SCALED", "ADD", "FRACTION"] | None = "SCALED",
    rotate_method: (
        typing.Literal["AXIS_ALIGNED", "AXIS_ALIGNED_X", "AXIS_ALIGNED_Y"] | None
    ) = "AXIS_ALIGNED_Y",
...
def snap_selected(
    ...
    *,
    target: (
        typing.Literal["PIXELS", "CURSOR", "CURSOR_OFFSET", "ADJACENT_UNSELECTED"]
        | None
    ) = "PIXELS",
) -> None:
...
def unwrap(
    ...
    *,
    method: (
        typing.Literal["ANGLE_BASED", "CONFORMAL", "MINIMUM_STRETCH"] | None
    ) = "CONFORMAL",
