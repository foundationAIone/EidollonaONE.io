...
def interactive_add(
    ...
    *,
    primitive_type: (
        typing.Literal["CUBE", "CYLINDER", "CONE", "SPHERE_UV", "SPHERE_ICO"] | None
    ) = "CUBE",
...
def toggle_shading(
    ...
    *,
    type: (
        typing.Literal["WIREFRAME", "SOLID", "MATERIAL", "RENDERED"] | None
    ) = "WIREFRAME",
) -> None:
...
def view_axis(
    ...
    *,
    type: (
        typing.Literal["LEFT", "RIGHT", "BOTTOM", "TOP", "FRONT", "BACK"] | None
    ) = "LEFT",
...
def view_orbit(
    ...
    *,
    ...
    type: (
        typing.Literal["ORBITLEFT", "ORBITRIGHT", "ORBITUP", "ORBITDOWN"] | None
    ) = "ORBITLEFT",
) -> None:
    """Orbit the view
