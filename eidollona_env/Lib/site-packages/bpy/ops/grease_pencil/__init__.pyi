...
def bake_grease_pencil_animation(
    ...
    *,
    ...
    project_type: (
        typing.Literal["KEEP", "FRONT", "SIDE", "TOP", "VIEW", "CURSOR"] | None
    ) = "KEEP",
) -> None:
...
def brush_stroke(
    ...
    *,
    stroke: (
        bpy.types.bpy_prop_collection[bpy.types.OperatorStrokeElement] | None
    ) = None,
...
def interpolate_sequence(
    ...
    *,
    ...
    easing: (
        bpy.stub_internal.rna_enums.BeztripleInterpolationEasingItems | None
    ) = "EASE_IN",
...
def outline(
    ...
    *,
    type: (
        typing.Literal["VIEW", "FRONT", "SIDE", "TOP", "CURSOR", "CAMERA"] | None
    ) = "VIEW",
...
def primitive_arc(
    ...
    *,
    ...
    type: (
        typing.Literal["BOX", "LINE", "POLYLINE", "CIRCLE", "ARC", "CURVE"] | None
    ) = "ARC",
) -> None:
...
def reproject(
    ...
    *,
    type: (
        typing.Literal["FRONT", "SIDE", "TOP", "VIEW", "SURFACE", "CURSOR"] | None
    ) = "VIEW",
...
def select_similar(
    ...
    *,
    mode: (
        typing.Literal["LAYER", "MATERIAL", "VERTEX_COLOR", "RADIUS", "OPACITY"] | None
    ) = "LAYER",
