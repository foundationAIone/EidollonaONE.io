...
def fades_add(
    ...
    *,
    ...
    type: (
        typing.Literal["IN_OUT", "IN", "OUT", "CURSOR_FROM", "CURSOR_TO"] | None
    ) = "IN_OUT",
) -> None:
...
def split(
    ...
    *,
    ...
    side: (
        typing.Literal["MOUSE", "LEFT", "RIGHT", "BOTH", "NO_CHANGE"] | None
    ) = "MOUSE",
...
def text_delete(
    ...
    *,
    type: (
        typing.Literal["NEXT_OR_SELECTION", "PREVIOUS_OR_SELECTION"] | None
    ) = "NEXT_OR_SELECTION",
) -> None:
