...
def gltf(
    ...
    *,
    ...
    export_import_convert_lighting_mode: (
        typing.Literal["SPEC", "COMPAT", "RAW"] | None
    ) = "SPEC",
    gltf_export_id: str = "",
    ...
    export_gltfpack_vpi: (
        typing.Literal["Integer", "Normalized", "Floating-point"] | None
    ) = "Integer",
    export_gltfpack_noq: bool | None = True,
    export_gltfpack_kn: bool | None = False,
    export_format: str | None = "",
    ui_tab: (
        typing.Literal["GENERAL", "MESHES", "OBJECTS", "ANIMATION"] | None
    ) = "GENERAL",
    ...
    export_materials: (
        typing.Literal["EXPORT", "PLACEHOLDER", "VIEWPORT", "NONE"] | None
    ) = "EXPORT",
    export_unused_images: bool | None = False,
    export_unused_textures: bool | None = False,
    export_vertex_color: (
        typing.Literal["MATERIAL", "ACTIVE", "NAME", "NONE"] | None
    ) = "MATERIAL",
    ...
    export_sampling_interpolation_fallback: (
        typing.Literal["LINEAR", "STEP"] | None
    ) = "LINEAR",
    export_pointer_animation: bool | None = False,
    export_animation_mode: (
        typing.Literal["ACTIONS", "ACTIVE_ACTIONS", "BROADCAST", "NLA_TRACKS", "SCENE"]
        | None
    ) = "ACTIONS",
    ...
    export_merge_animation: (
        typing.Literal["NLA_TRACK", "ACTION", "NONE"] | None
    ) = "ACTION",
