...
def convert(
    ...
    *,
    target: (
        typing.Literal["CURVE", "MESH", "POINTCLOUD", "CURVES", "GREASEPENCIL"] | None
    ) = "MESH",
...
def data_transfer(
    ...
    *,
    ...
    loop_mapping: (
        bpy.stub_internal.rna_enums.DtMethodLoopItems | None
    ) = "NEAREST_POLYNOR",
    ...
    layers_select_src: (
        bpy.stub_internal.rna_enums.DtLayersSelectSrcItems | None
    ) = "ACTIVE",
    layers_select_dst: (
        bpy.stub_internal.rna_enums.DtLayersSelectDstItems | None
    ) = "ACTIVE",
...
def geometry_node_bake_unpack_single(
    ...
    *,
    ...
    bake_id: int | None = 0,
    method: (
        typing.Literal["USE_LOCAL", "WRITE_LOCAL", "USE_ORIGINAL", "WRITE_ORIGINAL"]
        | None
    ) = "USE_LOCAL",
) -> None:
...
def modifier_add_node_group(
    ...
    *,
    asset_library_type: (
        bpy.stub_internal.rna_enums.AssetLibraryTypeItems | None
    ) = "LOCAL",
...
def parent_clear(
    ...
    *,
    type: (
        typing.Literal["CLEAR", "CLEAR_KEEP_TRANSFORM", "CLEAR_INVERSE"] | None
    ) = "CLEAR",
) -> None:
...
def paths_calculate(
    ...
    *,
    display_type: (
        bpy.stub_internal.rna_enums.MotionpathDisplayTypeItems | None
    ) = "RANGE",
...
def vertex_group_lock(
    ...
    *,
    ...
    mask: (
        typing.Literal["ALL", "SELECTED", "UNSELECTED", "INVERT_UNSELECTED"] | None
    ) = "ALL",
) -> None:
