...
def freestyle_alpha_modifier_add(
    ...
    *,
    type: (
        bpy.stub_internal.rna_enums.LinestyleAlphaModifierTypeItems | None
    ) = "ALONG_STROKE",
) -> None:
...
def freestyle_color_modifier_add(
    ...
    *,
    type: (
        bpy.stub_internal.rna_enums.LinestyleColorModifierTypeItems | None
    ) = "ALONG_STROKE",
) -> None:
...
def freestyle_geometry_modifier_add(
    ...
    *,
    type: (
        bpy.stub_internal.rna_enums.LinestyleGeometryModifierTypeItems | None
    ) = "2D_OFFSET",
) -> None:
...
def freestyle_thickness_modifier_add(
    ...
    *,
    type: (
        bpy.stub_internal.rna_enums.LinestyleThicknessModifierTypeItems | None
    ) = "ALONG_STROKE",
) -> None:
