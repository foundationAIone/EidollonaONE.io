...
def average_normals(
    ...
    *,
    average_type: (
        typing.Literal["CUSTOM_NORMAL", "FACE_AREA", "CORNER_ANGLE"] | None
    ) = "CUSTOM_NORMAL",
    weight: int | None = 50,
...
def bevel(
    ...
    *,
    offset_type: (
        typing.Literal["OFFSET", "WIDTH", "DEPTH", "PERCENT", "ABSOLUTE"] | None
    ) = "OFFSET",
    ...
    face_strength_mode: (
        typing.Literal["NONE", "NEW", "AFFECTED", "ALL"] | None
    ) = "NONE",
...
def bridge_edge_loops(
    ...
    *,
    ...
    profile_shape: (
        bpy.stub_internal.rna_enums.ProportionalFalloffCurveOnlyItems | None
    ) = "SMOOTH",
) -> None:
...
def delete(
    ...
    *,
    type: (
        typing.Literal["VERT", "EDGE", "FACE", "EDGE_FACE", "ONLY_FACE"] | None
    ) = "VERT",
) -> None:
...
def knife_tool(
    ...
    *,
    ...
    visible_measurements: (
        typing.Literal["NONE", "BOTH", "DISTANCE", "ANGLE"] | None
    ) = "NONE",
...
def merge(
    ...
    *,
    type: (
        typing.Literal["CENTER", "CURSOR", "COLLAPSE", "FIRST", "LAST"] | None
    ) = "CENTER",
    uvs: bool | None = False,
) -> None:
...
def poke(
    ...
    *,
    ...
    use_relative_offset: bool | None = False,
    center_mode: (
        typing.Literal["MEDIAN_WEIGHTED", "MEDIAN", "BOUNDS"] | None
    ) = "MEDIAN_WEIGHTED",
) -> None:
...
def polybuild_delete_at_cursor(
    ...
    *,
    ...
    proportional_edit_falloff: (
        bpy.stub_internal.rna_enums.ProportionalFalloffItems | None
    ) = "SMOOTH",
...
def shortest_path_pick(
    ...
    *,
    edge_mode: (
        typing.Literal["SELECT", "SEAM", "SHARP", "CREASE", "BEVEL", "FREESTYLE"] | None
    ) = "SELECT",
...
def subdivide(
    ...
    *,
    ...
    ngon: bool | None = True,
    quadcorner: (
        typing.Literal["INNERVERT", "PATH", "STRAIGHT_CUT", "FAN"] | None
    ) = "STRAIGHT_CUT",
...
def symmetrize(
    ...
    *,
    direction: (
        bpy.stub_internal.rna_enums.SymmetrizeDirectionItems | None
    ) = "NEGATIVE_X",
    threshold: float | None = 0.0001,
) -> None:
