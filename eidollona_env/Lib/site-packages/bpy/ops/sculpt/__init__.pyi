...
def cloth_filter(
    ...
    *,
    ...
    type: (
        typing.Literal["GRAVITY", "INFLATE", "EXPAND", "PINCH", "SCALE"] | None
    ) = "GRAVITY",
...
def mask_from_boundary(
    ...
    *,
    mix_mode: (
        typing.Literal["MIX", "MULTIPLY", "DIVIDE", "ADD", "SUBTRACT"] | None
    ) = "MIX",
...
def set_pivot_position(
    ...
    *,
    mode: (
        typing.Literal["ORIGIN", "UNMASKED", "BORDER", "ACTIVE", "SURFACE"] | None
    ) = "UNMASKED",
