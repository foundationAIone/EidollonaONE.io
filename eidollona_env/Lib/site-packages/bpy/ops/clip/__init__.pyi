...
def clean_tracks(
    ...
    *,
    ...
    action: (
        typing.Literal["SELECT", "DELETE_TRACK", "DELETE_SEGMENTS"] | None
    ) = "SELECT",
) -> None:
...
def detect_features(
    ...
    *,
    placement: (
        typing.Literal["FRAME", "INSIDE_GPENCIL", "OUTSIDE_GPENCIL"] | None
    ) = "FRAME",
    margin: int | None = 16,
...
def frame_jump(
    ...
    *,
    position: (
        typing.Literal["PATHSTART", "PATHEND", "FAILEDPREV", "FAILNEXT"] | None
    ) = "PATHSTART",
) -> None:
