...
def convert_to_mesh_plane(
    ...
    *,
    interpolation: (
        typing.Literal["Linear", "Closest", "Cubic", "Smart"] | None
    ) = "Linear",
    extension: typing.Literal["CLIP", "EXTEND", "REPEAT"] | None = "CLIP",
    alpha_mode: (
        typing.Literal["STRAIGHT", "PREMUL", "CHANNEL_PACKED", "NONE"] | None
    ) = "STRAIGHT",
...
def import_as_mesh_planes(
    ...
    *,
    ...
    align_axis: (
        typing.Literal["+X", "+Y", "+Z", "-X", "-Y", "-Z", "CAM", "CAM_AX"] | None
    ) = "CAM_AX",
    prev_align_axis: (
        typing.Literal["+X", "+Y", "+Z", "-X", "-Y", "-Z", "CAM", "CAM_AX", "NONE"]
        | None
...
def new(
    ...
    *,
    ...
    generated_type: (
        bpy.stub_internal.rna_enums.ImageGeneratedTypeItems | None
    ) = "BLANK",
