...
def alembic_export(
    ...
    *,
    ...
    filemode: int | None = 8,
    display_type: (
        typing.Literal["DEFAULT", "LIST_VERTICAL", "LIST_HORIZONTAL", "THUMBNAIL"]
        | None
    ) = "DEFAULT",
    ...
    quad_method: (
        bpy.stub_internal.rna_enums.ModifierTriangulateQuadMethodItems | None
    ) = "SHORTEST_DIAGONAL",
    ngon_method: (
        bpy.stub_internal.rna_enums.ModifierTriangulateNgonMethodItems | None
    ) = "BEAUTY",
...
def alembic_import(
    ...
    *,
    ...
    directory: str = "",
    files: (
        bpy.types.bpy_prop_collection[bpy.types.OperatorFileListElement] | None
    ) = None,
...
def batch_rename(
    ...
    *,
    ...
    actions: (
        bpy.types.bpy_prop_collection[bl_operators.wm.BatchRenameAction] | None
    ) = None,
) -> None:
...
def grease_pencil_export_pdf(
    ...
    *,
    ...
    selected_object_type: (
        typing.Literal["ACTIVE", "SELECTED", "VISIBLE"] | None
    ) = "ACTIVE",
...
def obj_export(
    ...
    *,
    ...
    forward_axis: (
        typing.Literal["X", "Y", "Z", "NEGATIVE_X", "NEGATIVE_Y", "NEGATIVE_Z"] | None
    ) = "NEGATIVE_Z",
    up_axis: (
        typing.Literal["X", "Y", "Z", "NEGATIVE_X", "NEGATIVE_Y", "NEGATIVE_Z"] | None
    ) = "Y",
    ...
    export_eval_mode: (
        typing.Literal["DAG_EVAL_RENDER", "DAG_EVAL_VIEWPORT"] | None
    ) = "DAG_EVAL_VIEWPORT",
    ...
    path_mode: (
        typing.Literal["AUTO", "ABSOLUTE", "RELATIVE", "MATCH", "STRIP", "COPY"] | None
    ) = "AUTO",
...
def obj_import(
    ...
    *,
    ...
    mtl_name_collision_mode: (
        typing.Literal["MAKE_UNIQUE", "REFERENCE_EXISTING"] | None
    ) = "MAKE_UNIQUE",
    filter_glob: str = "*.obj;*.mtl",
) -> None:
...
def set_stereo_3d(
    ...
    *,
    ...
    anaglyph_type: (
        bpy.stub_internal.rna_enums.Stereo3DAnaglyphTypeItems | None
    ) = "RED_CYAN",
    interlace_type: (
        bpy.stub_internal.rna_enums.Stereo3DInterlaceTypeItems | None
    ) = "ROW_INTERLEAVED",
...
def usd_export(
    ...
    *,
    ...
    export_materials: bool | None = True,
    export_subdivision: (
        typing.Literal["IGNORE", "TESSELLATE", "BEST_MATCH"] | None
    ) = "BEST_MATCH",
    ...
    usdz_downscale_size: (
        typing.Literal["KEEP", "256", "512", "1024", "2048", "4096", "CUSTOM"] | None
    ) = "KEEP",
...
def usd_import(
    ...
    *,
    ...
    mtl_purpose: (
        typing.Literal["MTL_ALL_PURPOSE", "MTL_PREVIEW", "MTL_FULL"] | None
    ) = "MTL_FULL",
    mtl_name_collision_mode: (
        typing.Literal["MAKE_UNIQUE", "REFERENCE_EXISTING"] | None
    ) = "MAKE_UNIQUE",
    import_textures_mode: (
        typing.Literal["IMPORT_NONE", "IMPORT_PACK", "IMPORT_COPY"] | None
    ) = "IMPORT_PACK",
    import_textures_dir: str = "//textures/",
    tex_name_collision_mode: (
        typing.Literal["USE_EXISTING", "OVERWRITE"] | None
    ) = "USE_EXISTING",
