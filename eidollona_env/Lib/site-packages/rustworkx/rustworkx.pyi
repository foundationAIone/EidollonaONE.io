...
_DijkstraVisitor = TypeVar(
    "_DijkstraVisitor", bound=DijkstraVisitor, default=DijkstraVisitor
)
...
def digraph_dfs_edges(
    graph: PyDiGraph[_S, _T], /, source: int | None = ...
) -> EdgeList: ...
def graph_dfs_edges(
    graph: PyGraph[_S, _T], /, source: int | None = ...
) -> EdgeList: ...
...
def immediate_dominators(
    graph: PyDiGraph[_S, _T], start_node: int, /
) -> dict[int, int]: ...
...
class AllPairsPathLengthMapping(
    _RustworkxCustomHashMapIter[int, PathLengthMapping]
): ...
...
@final
class BFSSuccessors(
    Generic[_T_co], _RustworkxCustomVecIter[tuple[_T_co, list[_T_co]]]
): ...
...
@final
class EdgeIndexMap(
    Generic[_T_co], _RustworkxCustomHashMapIter[int, tuple[int, int, _T_co]]
): ...
...
class WeightedEdgeList(
    Generic[_T_co], _RustworkxCustomVecIter[tuple[int, int, _T_co]]
): ...
...
@final
class AllPairsMultiplePathMapping(
    _RustworkxCustomHashMapIter[int, MultiplePathMapping]
): ...
...
class PyGraph(Generic[_S, _T]):
    ...
    def edge_subgraph(
        self, edge_list: Sequence[tuple[int, int]], /
    ) -> PyGraph[_S, _T]: ...
...
class PyDiGraph(Generic[_S, _T]):
    ...
    def in_edges(self, node: int, /) -> WeightedEdgeList[_T]: ...
    def incident_edge_index_map(
        self, node: int, /, all_edges: bool = ...
    ) -> EdgeIndexMap: ...
    ...
    def insert_node_on_in_edges_multiple(
        self, node: int, ref_nodes: Sequence[int], /
    ) -> None: ...
    ...
    def make_symmetric(
        self, edge_payload_fn: Callable[[_T], _T] | None = ...
    ) -> None: ...
