...
class AerStatevector(Statevector):
    ...
    @staticmethod
    def _aer_evolve_circuit(
        aer_state, circuit, qubits, basis_gates=None, custom_insts=None
    ):
    ...
    @staticmethod
    def _aer_evolve_instruction(
        aer_state, inst, qubits, basis_gates=None, custom_insts=None
    ):
