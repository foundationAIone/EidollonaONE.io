...
class AerBackendProperties:
    ...
    def is_gate_operational(
        self, gate: str, qubits: Union[int, Iterable[int]] = None
    ) -> bool:
        """
    ...
    def gate_error(self, gate: str, qubits: Union[int, Iterable[int]]) -> float:
        ...
        """
        return self.gate_property(gate, qubits, "gate_error")[
            0
    ...
    def gate_length(self, gate: str, qubits: Union[int, Iterable[int]]) -> float:
        ...
        """
        return self.gate_property(gate, qubits, "gate_length")[
            0
        ]  # Throw away datetime at index 1
    ...
    def frequency(self, qubit: int) -> float:
        ...
        """
        return self.qubit_property(qubit, "frequency")[
            0
        ]  # Throw away datetime at index 1
    ...
    def readout_error(self, qubit: int) -> float:
        ...
        """
        return self.qubit_property(qubit, "readout_error")[
            0
        ]  # Throw away datetime at index 1
    ...
    def readout_length(self, qubit: int) -> float:
        ...
        """
        return self.qubit_property(qubit, "readout_length")[
            0
        ]  # Throw away datetime at index 1
